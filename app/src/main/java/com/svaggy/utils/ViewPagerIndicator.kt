...
class ViewPagerIndicator : LinearLayout, ViewPager.OnPageChangeListener, ViewPager.OnAdapterChangeListener {
    ...
    private var mAnimScaleMultiplier = 1f
    ...
    private fun initializeViews(context: Context, attrs: AttributeSet?) {
        ...
        if (attrs != null) {
            ...
            mSelectedColor = a.getColor(R.styleable.ViewPagerIndicator_selectedColor, getThemeColor(context, R.color.primaryColor))
            ...
            mIndicatorSpacing = a.getDimension(R.styleable.ViewPagerIndicator_indicatorSpacing, 30f).toInt()
    ...
    private fun setSelectedIndicator(selected: Int) {
        ...
        for (i in 0 until num) {
            ...
            img?.let {
                ...
                {
                    img.setImageResource(R.drawable.bg_round_white)
                    img.colorFilter = LightingColorFilter(0, mDeselectedColor)
                }
            }
        }
