...
public class VerticalStepViewIndicator extends View
{
    ...
    private void init()
    {
        ...
        mCompleteIcon = ContextCompat.getDrawable(getContext(), R.drawable.ic_track_order_done);//已经完成的icon
        mAttentionIcon = ContextCompat.getDrawable(getContext(), R.drawable.ic_track_order_pending);//正在进行的icon
        mDefaultIcon = ContextCompat.getDrawable(getContext(), R.drawable.ic_track_order_pending);//未完成的icon
