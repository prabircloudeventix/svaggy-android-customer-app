package com.svaggy.ui.fragments.cart.scroll_choice;
...
public abstract class WheelPicker extends View {
    ...
    public WheelPicker(Context context, AttributeSet attrs) {
        ...
        mItemTextColor = a.getColor(R.styleable.WheelPicker_scroll_item_text_color, 0xFF040404);
        backgroundColor = a.getColor(R.styleable.WheelPicker_scroll_background_color, 0xFFF5F5F5);
        backgroundOfSelectedItem = a.getColor(R.styleable.WheelPicker_scroll_selected_item_background, 0xF4F4F5);
